      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Minecraft Hosting", "Modpack Servers", "Game Servers", "Web Hosting", "VPS Hosting"].map((item) => (
                <li key={item}>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Documentation", "Blog", "Tutorials", "Status", "Support Center"].map((item) => (
                <li key={item}>
                  <Link href="#" className="text-blue-300 hover:text-blue-400 transition-colors">
                    {item}
                  </Link>
        ...
        <div className="border-t border-blue-900/50 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-blue-300 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} Nexonoia Host. All rights reserved.
          </p>
